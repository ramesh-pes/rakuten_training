...
public class ProductClient {
	public static void main(String[] args) {
		//using Annotations based spring
		AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext();
		
		//if we are usinng XML based for  spring we use ClassPathXMLApplicationncontext("beans.xml")
		//creates object and stores in spring rpositirty
		...
		System.out.println("Products are innserted");
       
        //os.insertProduct(products);
	}
}
